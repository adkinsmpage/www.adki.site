                                ...
                                <dl className='-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6'>
                                        ...
                                        <dd className='flex items-start gap-x-2 overflow-y-auto'>
                                            {post.frontmatter.tags.map(
                                                (tag, i) => (
                                                    <span
                                                        key={i}
                                                        className='inline-flex items-center rounded-md bg-gray-100 dark:bg-gray-400/10 px-2 py-1 text-xs font-medium text-gray-600 dark:text-gray-400'
                                                    >
                                                        {tag}
                                                    </span>
                                                ),
                                    ...
                                    <div className='flex justify-between gap-x-4 py-3'>
                                        ...
                                        <dd className='flex items-start gap-x-2'>
                                            <div className='inline-flex items-center rounded-md bg-gray-100 dark:bg-gray-400/10 px-2 py-1 text-xs font-medium text-gray-600 dark:text-gray-400'>
