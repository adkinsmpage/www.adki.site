...
export default function HeaderNav() {
    ...
    return (
        <div className='flex fixed top-6 inset-x-0 justify-center items-center gap-8 w-fit mx-auto px-8 rounded-3xl bg-white/70 dark:bg-black/45 backdrop-blur-lg backdrop-saturate-150 border border-transparent shadow-sm z-50'>
