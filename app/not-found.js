  ...
  return (
    <div className="relative text-center z-[1] pt-52">
      ...
      <div
        ...
        <Button onClick={() => history.go(-1)} variant="secondary" asChild className="group">
            <ArrowLeft
...
export default function App() {
  return <div className="relative flex flex-col w-full justify-center min-h-svh bg-background p-6 md:p-10">
